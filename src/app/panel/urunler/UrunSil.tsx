...
interface UrunSilProps {
  id: number;
  ad: string;
}

export function UrunSil({ id, ad }: UrunSilProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="w-full max-w-md p-6 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 shadow-2xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Ürünü Sil</h3>
                <p className="text-sm text-foreground-secondary">Bu işlem geri alınamaz</p>
              </div>
            </div>
            <p className="text-foreground-secondary mb-6">
              <strong className="text-foreground">&quot;{ad}&quot;</strong> ürününü silmek istediğinizden emin misiniz?
            </p>
